...
const serie1 = new Serie("Lord of The Rings", "url:https://img.turl.lor.jpg", dramaCategoria,
                          "Episodio 1: La guerra", "Frodo le declara la guerra a todos", 120,
                          plataforma1, actor1, director1)

const serie2 = new Serie("the boyz", "url:https://img.turl.boyz.jpg", accionCategoria,
                            "Episodio 1: The team", "El equipo de anthieroes se reúne", 60,
                            plataforma1, actor3, director1)
                            
const serie3 = new Serie("Squid Games", "url:https://img.turl.sqg.jpg", suspensoCategoria,
                            "Episodio 1: El drama empieza", "Jong es contactado por...", 39,
                            plataforma2, actor3, director3)

const serie4 = new Serie("La serie de prueba", "url:https://img.turl.serieprueba.jpg", ficcionCategoria,
                            "Episodio 1: test test", "es una prueba...", 22,
                            plataforma3, actor4, director2)
 ...
 * 
 */
function crearNuevaSerie(nombreSerie:string, img:string, categoria:Categoria,
    nombreEpisodio:string, resumen:string, duracion:number,
    plataforma:Plataforma, actor:Persona, director:Persona ):Serie {
...
function crearNuevaCategoria(nombre:string){ new Categoria(nombre) }
 ...
 * @param serie 
 */
function crearNuevoActor( nombre: string, fotoUrl:string, description:string, serie:Serie):void{
 ...
 */
function crearNuevodirector( nombre: string, fotoUrl:string, description:string, serie:Serie):void{
